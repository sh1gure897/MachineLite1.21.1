...
public class ModuleListCommand extends Command {
    ...
    public void fire(String[] args) {
        ...
        for (Module module : MachineLite.getModuleManager().getModules()) {
            MachineLite.WriteChat(((module.getKeyCode() != 0) ? "\2477Name: " + (module.isEnabled() ? "\247a" : "\247c") + module.getName() + "\2477, Key: \2479" + InputUtil.fromKeyCode(module.getKeyCode(), -1).getLocalizedText().getString() : "\2477Name: " + (module.isEnabled() ? "\247a" : "\247c") + module.getName()) + "\2477,");
        }
